...
public class SecondPrefResult extends RecyclerView.Adapter<SecondPrefResult.ViewHolder>{
    private Context mContext;
    private List<ResultData> second_pref_list;
    private DatabaseReference UsersRef;


    public SecondPrefResult(Context mContext, List<ResultData> second_pref_list){
        this.mContext = mContext;
        this.second_pref_list = second_pref_list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SecondPrefResult.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SecondPrefResult.ViewHolder holder, int position) {

        final ResultData user = second_pref_list.get(position);
